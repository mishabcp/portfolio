...
const SkillsSection = () => {
  ...
  return (
    <section
      ref={skillsRef}
      id="skills-section"
      className={`skills-section-container w-4/5 lg:w-3/5 mx-auto mb-20 lg:mb-40 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-1000 ease-in-out `}
    >
