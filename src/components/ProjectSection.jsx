...
const ProjectSection = () => {
  ...
  return (
    <div id='Project-Section'
      ref={projectRef}
      className={`container w-4/5 lg:w-3/5 bg-white mx-auto mb-20 lg:mb-32 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-1000 ease-in-out`}
    >
