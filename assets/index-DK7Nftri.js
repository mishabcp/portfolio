...
import{i as u,a as _,e as g,l as D,_ as T}from"./index-B9ytZTpw.js";const h=2,d=.5;function O(r){const{context:e,particle:t,radius:i,opacity:n}=r,a=t.shapeData;if(!a)return;const l=a.value;if(l===void 0)return;t.text===void 0&&(t.text=u(l,t.randomIndexData));const o=t.text,c=a.style??"",x=a.weight??"400",y=Math.round(i)*h,m=a.font??"Verdana",w=t.shapeFill,p=o==null?void 0:o.split(`
